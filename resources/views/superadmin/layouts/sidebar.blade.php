<div class="logo">
  <div class="brand">NEBENG</div>
  <div class="tagline">TRANSPORTASI MENJADI LEBIH MUDAH</div>
</div>
...
<div class="menu">
  ...
  <div class="nav">
    ...
    <a href="{{ route('sa.mitra.kendaraan') }}" class="{{ request()->routeIs('sa.mitra.kendaraan') ? 'active' : '' }}">🚗 Kendaraan Mitra</a>
...
<div class="logout">
  {{-- sementara (mock). nanti ganti ke route logout asli --}}
  <button onclick="alert('Logout sementara (mock). Nanti pakai logout asli dari auth temanmu.')">🚪 Keluar</button>
</div>
