...
@section('title', 'Pencairan Dana Pos Mitra')
...
<div class="bg-white rounded-xl shadow p-6 space-y-6">
    ...
    <div class="px-6 pt-6 pb-4">
        <h1 class="text-lg font-semibold text-gray-800 mb-4">
            Pencairan Dana Pos Mitra
        </h1>

        <div class="flex items-center justify-between">
            <form action="{{ route('withdrawals.partner-post.index') }}" method="GET" class="relative w-64">
                <input
                    type="text"
                    name="search"
                    placeholder="Search..."
            ...
            <form action="{{ route('withdrawals.partner-post.index') }}" method="GET">
                <select
                    name="status"
        ...
        <table class="w-full text-sm">
            <thead class="bg-blue-50 text-gray-700">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left font-medium">NAMA POS MITRA</th>
                    <th class="px-6 py-3 text-left font-medium">PEMILIK</th>
            ...
            <tbody class="divide-y">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-gray-800">
                        <div class="font-medium">{{ $item->partnerPost->terminal_name ?? '-' }}</div>
                    </td>
                    <td class="px-6 py-4 text-gray-800">
                        <div class="font-medium">{{ $item->partnerPost->user->name ?? '-' }}</div>
                    </td>
                    ...
                    <td class="px-6 py-4 text-center">
                        <a href="{{ route('withdrawals.partner-post.show', $item->id) }}"
                ...
                <tr>
                    <td colspan="7" class="px-6 py-8 text-center text-gray-500">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-600">Tidak ada data pencairan pos mitra ditemukan.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
